...
-   Tính tái lập (reproducibility): các file code R sẽ mô tả toàn bộ quá
    ...
    hoặc áp dụng các code đã có (một phần hoặc toàn bộ) cho các dự án
    khác của bạn; và (2) bạn có thể tái lập (hoặc học phương pháp) những
    nghiên cứu khác hoặc những nhà nghiên cứu khác sẽ có thể tái lập
    (hoặc học phương pháp) nghiên cứu của bạn. Lý do thứ 2 đặc biệt quan
    trọng trong nghiên cứu khoa học và việc công khai dữ liệu hoặc/và
    các file code sử dụng trong nghiên cứu được khuyến khích bởi hầu hết
